...
export interface TOKENInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "burn(address,uint256,bytes)",
...
export interface TOKEN extends BaseContract {
  ...
  "burn(address,uint256,bytes)": TypedContractMethod<
    [account: AddressLike, amount: BigNumberish, id: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "burn(address,uint256,bytes)"
  ): TypedContractMethod<
    [account: AddressLike, amount: BigNumberish, id: BytesLike],
    [void],
    "nonpayable"
  ...
  filters: {
    ...
    "Burn(address,bytes,string,uint256)": TypedContractEvent<
      BurnEvent.InputTuple,
      BurnEvent.OutputTuple,
      BurnEvent.OutputObject
    >;
    ...
    "Mint(address,bytes,string,uint256)": TypedContractEvent<
      MintEvent.InputTuple,
      MintEvent.OutputTuple,
      MintEvent.OutputObject
    >;
